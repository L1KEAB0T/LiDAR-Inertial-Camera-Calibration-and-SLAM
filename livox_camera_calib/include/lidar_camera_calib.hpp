...
public:
  ...
  Calibration(const std::string &image_file, pcl::PointCloud<pcl::PointXYZI> pcd, const std::string &calib_config_file);
...
Calibration::Calibration(const std::string &image_file,
      ...
      ROS_INFO_STREAM(msg.c_str());
        ...
        raw_lidar_cloud_ = pcl::PointCloud<pcl::PointXYZI>::Ptr(new pcl::PointCloud<pcl::PointXYZI>(pcd));
        ROS_INFO_STREAM("Using streamed point cloud, size: " + std::to_string(raw_lidar_cloud_->size()));
